...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 04 2019 г., 09:25
...
INSERT INTO `products` (`id`, `slug`, `title`, `excerpt`, `content`, `descrtitle`, `descrtext`, `descr`, `regular_price`, `sale_price`, `discount`, `currency`, `image`, `is_reccomended`, `product_description_tab_content`, `product_ingredients_tab_content`, `product_usage_tab_content`) VALUES
