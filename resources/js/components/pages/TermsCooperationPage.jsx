...
class TermsCooperationPage extends Component {
    render(){
        return (
            <React.Fragment>
                    ...
                    <div className="row">
                        <div className="col-xs-12">
                            <div className="kama_breadcrumbs" itemScope="" itemType="http://schema.org/BreadcrumbList">
                                ...
                                <span className="kb_sep"> / </span>Условия сотрудничества
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-xs-12">
                            <article id="post-10" className="post-10 page type-page status-publish hentry">
                                <header className="entry-header">
                                    <h1 className="entry-title">Условия сотрудничества</h1>
                                </header>
                                <div className="entry-content dinamyc-page">
                                    <h1 style={{textAlign: 'center'}}>Если вам нужен успешный бизнес,</h1>
                                    <h1 style={{textAlign: 'center'}}>а не единичные продажи – значит вам нужен надежный партнер.</h1>
                                    <h3 style={{textAlign: 'center'}}>
                                        <span style={{color: '#000000'}}>Мы предлагаем вам надежное и долгосрочное сотрудничество.</span>
                                        <br/>
                                        <span style={{color: '#000000'}}>Мы предлагаем вам наладить бизнес с качественным товаром</span>
                                        <br/>
                                        <span style={{color: '#000000'}}>на выгодных условиях, а не единожды продать.</span>
                                        <br/>
                                        <span style={{color: '#000000'}}>Мы предлагаем вам быть лидером!</span>
                                    </h3>
                                    ...
                                    <div className="contacts__formInner">
                                        <div className="contacts__form">
                                            <div role="form" className="wpcf7" id="wpcf7-f1040-p10-o2" lang="ru-RU" dir="ltr">
                                                <div className="screen-reader-response"></div>
                                                <form action="/terms-cooperation/#wpcf7-f1040-p10-o2" method="post"
                                                ...
                                                >
                                                    <div style={{display: 'none'}}>
                                                        ...
                                                        <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f1040-p10-o2"/>
                                                            ...
                                                            <p>
                                                                <label><span>Ваше имя*</span>
                                                                    ...
                                                                    <span className="wpcf7-form-control-wrap feedback-form-name">
                                                                        <input type="text" name="feedback-form-name"
                                                                               value="" size="40"
                                                            ...
                                                            <p>
                                                                <label><span>Телефон*</span>
                                                                    ...
                                                                    <span className="wpcf7-form-control-wrap feedback-form-phone">
                                                                        <input type="text" name="feedback-form-phone"
                                                                               value="" size="40"
                                                                               className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                                                               aria-required="true" aria-invalid="false"
                                                                        />
                                                            ...
                                                            <p>
                                                                <label><span>E-Mail*</span>
                                                                    ...
                                                                    <span className="wpcf7-form-control-wrap feedback-form-email">
                                                                        <input type="text" name="feedback-form-email"
                                                                               value="" size="40"
                                                                               className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                                                               aria-required="true" aria-invalid="false"
                                                                        />
                                        ...
                                        <div className="contacts__info">
                                            ...
                                            <div className="contacts__infoContent">
                                                <p>С удовольствием обсудим все интересующие вас вопросы в нашем главном
                                                    офисе за чашечкой кофе.</p>
...
export default TermsCooperationPage;