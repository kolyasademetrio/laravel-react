...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'size'                            => 'Размер',
        'slug'                            => 'Slug',
        'descrtitle'                      => 'Короткий заголовок',
        'descrtext'                       => 'Короткий текст',
        'descr'                           => 'Описание',
        'regular_price'                   => 'Цена',
        'discount'                        => 'Скидка',
        'currency'                        => 'Валюта',
    ...
    'labels' => [
        'product' => [
            ...
            'currency'                        => 'введите валюту товара',
            'image'                           => 'добавьте изображение товара',
            'tab_bg'                          => 'введите фоновое изображение вкладок товара',
            ...
            'product_usage_tab_contenttab_bg' => 'введите контент вкладки "Использование" товара',
            'all_product_categories_list'     => 'список всех категорий товара',
            'add_product_category'            => 'добавьте категорию товара',
            'no_product_category_to add'      => 'нет категорий для добавления',
        ],
        'name'                            => 'введите имя',
