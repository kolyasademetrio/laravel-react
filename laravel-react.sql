...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 29 2019 г., 18:48
...
INSERT INTO `products` (`id`, `slug`, `title`, `excerpt`, `content`, `descrtitle`, `descrtext`, `regular_price`, `sale_price`, `discount`, `currency`, `image`, `is_reccomended`) VALUES
(1, 'крем-для-рук-и-ногтей', 'Крем для рук и ногтей', 'питательный крем 250 мл', '', 'Крем для рук и ногтей', 'Крем для рук и ногтей', '115', '0', '0.00', 'грн', '/uploads/2018/10/250ml_1_07-600x587.jpg', 1),
...
(4, 'скраб-крем-апельсин', 'Скраб-крем апельсин', 'сахарный крем-скраб 180 г', '', 'Скраб-крем апельсин', 'Крем-скраб', '75', '0', '0.00', 'грн', '/uploads/2018/10/180-g_scrub-cream__01-600x587.jpg', 1),
(5, 'скраб-крем-дыня', 'Скраб-крем дыня', 'сахарный крем-скраб 180 г', '', 'Скраб-крем дыня', 'Крем-скраб', '75', '0', '0.00', 'грн', '/uploads/2018/10/180-g_scrub-cream__03-600x587.jpg', 1),
(6, 'детский-крем', 'Детский крем', 'гипоалергенный крем 50 мл', '', 'Детский крем', 'Использование защитного гипоалергеного крема Crema Protettiva dei Piccoli может стать отличным способом профилактики многих дерматологических симптомов.', '595', '500', '16.00', 'грн', '/uploads/2018/08/50-ml_0006-600x587.jpg', 1),
...
(9, 'ночной-питательный-крем', 'Питательный крем', 'ночной питательный крем 5 мл', '', 'Питательный крем', 'Благодаря своим органическим компонентам, ночной питательный крем Alga Ph, обеспечивает коже максимально здоровое природное питание.<br/> Помимо увлажнения он насыщает кожу минералами, витаминами и аминокислотами.', '245', '215', '12.00', 'грн', '/uploads/2018/07/5-ml_0002-600x587.jpg', 1),
(10, 'скраб-крем-клубника', 'Скраб-крем клубника', 'сахарный крем-скраб 180 г', '', 'Скраб-крем клубника', 'Крем-скраб', '75', '0', '0.00', 'грн', '/uploads/2018/10/180-g_scrub-cream__02-600x587.jpg', 0),
(11, 'скраб-крем-ананас', 'Скраб-крем ананас', 'сахарный крем-скраб 180 г', '', 'Скраб-крем ананас', 'Крем-скраб', '75', '0', '0.00', 'грн', '/uploads/2018/10/180-g_scrub-cream__04-600x587.jpg', 0),
(12, 'скраб-крем-красные-ягоды', 'Скраб-крем красные ягоды', 'сахарный крем-скраб 180 г', '', 'Скраб-крем красные ягоды', 'Крем-скраб', '75', '0', '0.00', 'грн', '/uploads/2018/10/180-g_scrub-cream__05-600x587.jpg', 0),
(13, 'скраб-крем-фруктовый-микс', 'Скраб-крем фруктовый микс', 'сахарный крем-скраб 180 г', '', 'Скраб-крем фруктовый микс', 'Крем-скраб', '75', '0', '0.00', 'грн', '/uploads/2018/10/180-g_scrub-cream__05-600x587.jpg', 0);
